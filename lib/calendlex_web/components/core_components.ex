defmodule CalendlexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LiveDraftWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LiveDraftWeb.Gettext, "errors", msg, opts)
    # end
