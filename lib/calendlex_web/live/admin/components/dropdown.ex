defmodule CalendlexWeb.Admin.Components.Dropdown do
  ...
  def main(assigns) do
    ~H"""
    <div id={@id} class="relative dropdown" phx-click-away={click_away(@id)}>
      <div
      ...
      <div class="absolute right-0 z-20 flex flex-col hidden py-2 mt-2 overflow-hidden text-sm text-gray-800 bg-white border rounded-md shadow-md dropdown-content">
